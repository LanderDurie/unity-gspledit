...
namespace UnityEngine.GsplEdit
{
    ...
    public class DualContouringGen : MeshGenBase
    {
        ...
        private void GenerateMesh(Settings settings, List<SplatData> splats, OctreeNode node, List<Vector3> vertices, List<int> indices)
        {
            if (node == null) return;
        ...
        private void GenerateCube(Settings settings, OctreeNode node, List<Vector3> vertices, List<int> indices, List<SplatData> splats) {
        ...
        private void GeneratePoint(Vector3 center, List<Vector3> vertices, List<int> indices) {
