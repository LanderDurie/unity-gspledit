...
{
    public class EuclideanGen : LinkGenForwardBase
    {
        [System.Serializable]
        ...
        public unsafe override void Generate(SharedComputeContext context) {
            ...
            m_DistanceBasedLinkageCompute.SetBuffer(0, "_VertexBasePos", context.scaffoldBaseVertex);
            m_DistanceBasedLinkageCompute.SetBuffer(0, "_SplatLinks", context.forwardLinks);
            m_DistanceBasedLinkageCompute.SetBuffer(0, "_MeshIndices", context.scaffoldIndices);
            ...
            m_DistanceBasedLinkageCompute.SetInt("_IndexCount", context.scaffoldData.indexCount);
            m_DistanceBasedLinkageCompute.SetFloat("_GlobalSigma", m_Settings.sigma);
