namespace UnityEngine.GsplEdit
{
    public class EuclideanGen : LinkGenForwardBase
    {
        ...
        public unsafe override void Generate(SharedComputeContext context) {
            ...
            m_DistanceBasedLinkageCompute.SetBuffer(0, "_VertexBasePos", context.gpuMeshBaseVertex);
            m_DistanceBasedLinkageCompute.SetBuffer(0, "_SplatLinks", context.gpuForwardLinks);
            m_DistanceBasedLinkageCompute.SetBuffer(0, "_MeshIndices", context.gpuMeshIndices);
            ...
            m_DistanceBasedLinkageCompute.SetInt("_IndexCount", context.indexCount);
