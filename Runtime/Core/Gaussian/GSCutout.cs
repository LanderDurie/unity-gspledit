...
{
    public class GSCutout : MonoBehaviour
    {
        public enum Type
        {
            Ellipsoid,
        ...
        public struct ShaderData // match GSCutoutShaderData in CS
        {
            public Matrix4x4 matrix;
            public uint typeAndFlags;
        }

        public static ShaderData GetShaderData(GSCutout self, Matrix4x4 rendererMatrix)
        {
        ...
        public void OnDrawGizmos()
        {
            ...
            else
            {
                ...
                if (activeGo != null)
                {
                    var activeSplat = activeGo.GetComponent<GSRenderer>();
                    if (activeSplat != null)
                    {
