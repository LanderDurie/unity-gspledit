    ...
    class GSRenderSystem {
        ...
        public bool GatherSplatsForCamera(Camera cam) {
            ...
            foreach (var kvp in m_Splats) {
                ...
                if (!gs.m_IsActiveAndEnabled || !gs.m_SharedContext.SplatDataValid() || !gs.HasValidRenderSetup())
                    continue;
        ...
        public Material SortAndRenderSplats(Camera cam, CommandBuffer cmb) {
            ...
            foreach (var kvp in m_ActiveSplats) {
                ...
                mpb.SetBuffer("_VertexBasePos", gs.m_SharedContext.scaffoldBaseVertex);
                mpb.SetBuffer("_VertexModPos", gs.m_SharedContext.scaffoldModVertex);
                mpb.SetBuffer("_VertexDeletedBits", gs.m_SharedContext.scaffoldDeletedBits);
                mpb.SetBuffer("_MeshIndices", gs.m_SharedContext.scaffoldIndices);
                mpb.SetBuffer("_SplatLinks", gs.m_SharedContext.forwardLinks);
                mpb.SetTexture("_OffscreenMeshTexture", gs.m_SharedContext.offscreenBuffer);
                ...
                // draw
                int indexCount = 6;
                int instanceCount = gs.m_SharedContext.gsSplatCount;
                ...
                if (gs.m_RenderMode == GSRenderer.RenderMode.DebugChunkBounds)
                    instanceCount = gs.m_SharedContext.gsChunksValid ? gs.m_SharedContext.gsChunks.count : 0;
        ...
        public void OnPreCullCamera(Camera cam) {
            ...
            if (m_Context.offscreenCam != null && cam == m_Context.offscreenCam) {
                return;
            }
