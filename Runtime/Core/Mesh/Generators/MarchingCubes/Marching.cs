...
namespace UnityEngine.GsplEdit.MarchingCubes
{
   public abstract class Marching
    {
        ...
        public virtual void Generate(float[,,] voxels, IList<Vertex> verts, IList<int> indices)
        {
        ...
        /// <param name="verts"></param>
        /// <param name="indices"></param>
        public virtual void Generate(IList<float> voxels, int width, int height, int depth, IList<Vertex> verts, IList<int> indices)
        {
        ...
        /// </summary>
        protected abstract void March(float x, float y, float z, float[] cube, IList<Vertex> vertList, IList<int> indexList);
