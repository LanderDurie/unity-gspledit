...
namespace UnityEngine.GsplEdit
{
    ...
    {
        public static void OptimizeMesh(ref Vertex[] vertices, ref uint[] indices)
        {
            ...
            List<uint> optimizedIndices = new List<uint>();
            ...
            for (int i = 0; i < indices.Length; i++)
            {
                ...
                bool found = false;
                foreach (uint existingIndex in bucket)
                {
                ...
                if (!found)
                {
                    ...
                    optimizedIndices.Add((uint)uniqueVertices.Count - 1);
                }
            }
        ...
        public static void ExtractUniqueEdges(uint[] indexList, ref Edge[] edgeList)
        {
            ...
            {
                uint v1 = indexList[i];
                uint v2 = indexList[i + 1];
                uint v3 = indexList[i + 2];
